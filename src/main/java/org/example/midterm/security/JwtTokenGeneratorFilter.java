package org.example.midterm.security;
...
public class JwtTokenGeneratorFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException {
        ...
        String token = Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS512, "verysecretkeyverysecretkeyverysecretkeyverysecretkeyverysecretkeyverysecretkey".getBytes())
                .compact();
